...
const Menu: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      description:
        "Pan-seared scallops, cauliflower purée, golden raisins, pine nuts, brown butter",
      price: "$32",
      category: "starters",
      featured: true,
    },
    {
      ...
      description:
        "Smooth foie gras parfait, Sauternes jelly, toasted sourdough",
      price: "$30",
      category: "starters",
    },
    {
      ...
      description:
        "45-day aged beef, pomme purée, wild mushrooms, red wine jus",
      price: "$68",
      category: "mains",
      featured: true,
    },
    {
      ...
      description:
        "Whole Dover sole, brown butter, lemon, capers, parsley, new potatoes",
      price: "$72",
      category: "mains",
    },
    {
      ...
      name: "Rack of Lamb",
      description:
        "Herb-crusted lamb rack, eggplant caviar, grilled artichokes, rosemary jus",
      price: "$64",
      category: "mains",
    },
    {
      ...
      description:
        "Warm chocolate soufflé, vanilla bean ice cream, chocolate tuile",
      price: "$22",
      category: "desserts",
      featured: true,
    },
    {
      ...
      name: "Crème Brûlée",
      description:
        "Classic vanilla bean crème brûlée, seasonal berries, shortbread biscuit",
      price: "$18",
      category: "desserts",
    },
    {
      ...
      name: "Tarte Tatin",
      description:
        "Caramelized apple tart, vanilla bean ice cream, salted caramel sauce",
      price: "$20",
      category: "desserts",
    },
  ];
  ...
  return (
    <section
      id="menu"
      ref={sectionRef}
      className="section bg-black py-24 relative"
    >
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-cream opacity-80 max-w-xl mx-auto">
            A curated selection of exquisite dishes that showcase the finest
            seasonal ingredients and our chef's creativity
          </p>
        </div>
          ...
          <div className="flex space-x-2 md:space-x-8 border-b border-burgundy">
            {["starters", "mains", "desserts"].map((category) => (
              <button
                ...
                onClick={() =>
                  setActiveCategory(
                    category as "starters" | "mains" | "desserts"
                  )
                }
              >
                {category}
          ...
          {filteredItems.map((item) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-gold font-playfair text-xl">
                  {item.price}
                </span>
              </div>
